...
console.log(saudação("Lucas")); // Saída: Olá, Lucas!

// Hoisting: Elevação de parâmetros em JS. Ou seja, tacar uma variável lá pra cima no código.
...
exibirTarefa(2, "Estudar Python", "alta");
...
console.log(tarefa);
const tarefa2 = criarTarefa("Estudar funções", "Variáveis são declaradas utilizando let e const sempre!", "Alta", false);
console.log(tarefa2);
...
const dobrados = numeros.map(n => n * 2); // .map é um laço de repetição para arrays e traz outro array como resultado.
